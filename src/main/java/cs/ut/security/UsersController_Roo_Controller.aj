...
import cs.ut.security.UsersController;
...
privileged aspect UsersController_Roo_Controller {
    ...
    public String UsersController.create(@Valid Assignments assignments, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        ...
        uiModel.asMap().clear();
        assignments.persist();
        return "redirect:/security/users/" + encodeUrlPathSegment(assignments.getId().toString(), httpServletRequest);
    }
    ...
    public String UsersController.update(@Valid Assignments assignments, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, assignments);
    ...
    void UsersController.populateEditForm(Model uiModel, Assignments assignments) {
